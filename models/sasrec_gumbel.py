...
class SASPolicyNet:
    def __init__(self, args):
        ...
        self.logits_check_train, self.action_predict_train = self.build_policy(
            self.input, train=True
        )

        self.logits_check_test, self.action_predict_test = self.build_policy(
